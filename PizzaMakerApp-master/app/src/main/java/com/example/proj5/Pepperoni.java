...
/**
 * A Pepperoni pizza as extended by a pizza.
 * This class contains specific data and methods that are particular to this class.
 * Operations relate to Pepperoni class and textual representation of the object.
 * @author Pooja Panchal
 */
public class Pepperoni extends Pizza implements Serializable {
    private static double INITAL_PRICE = 0;
    private static int INITIAL_TOPPINGS = 1;
    private static int NO_TOPPINGS = 0;
    private static double EXTRA_TOPPING_RATE = 1.49;
    private static double SMALL_BASE_PRICE = 8.99;
    private static double MED_BASE_PRICE = 10.99;
    private static double LARGE_BASE_PRICE = 12.99;
    ...
    /**
     * This method returns the string representation of a pepperoni pizza.
     * @return The string representation of a pepperoni pizza, inclusive of its size and prize excluding tax.
     */
    @Override
    public String toString(){
        return "Pepperoni Pizza, " + toppings + ", " + getSize() + ", $" + String.valueOf(price());
    }
    ...
    public String exportString(){
        return "Pepperoni Pizza, " + toppings + ", " + getSize();
    }
}
